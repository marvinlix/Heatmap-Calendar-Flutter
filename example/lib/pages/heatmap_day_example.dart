...
class HeatMapDayExample extends StatefulWidget {
  const HeatMapDayExample({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _HeatMapExample();
}

class _HeatMapExample extends State<HeatMapDayExample> {
  ...
  static DateTime startDayOfYear(final DateTime referenceDate) => DateTime(referenceDate.year, 1, 1);

  /// Get last day of month.
  static DateTime endDayOfYear(final DateTime referenceDate) => DateTime(referenceDate.year, 12, 31);
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                setState(() {
                  heatMapDatasets[DateTime.parse(dateController.text)] = HeatmapData(intensity: int.parse(heatLevelController.text));
                });
              },
            ),
